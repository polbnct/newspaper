                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8 mt-8">
                        ...
                        <div class="flex items-center space-x-2 mt-2">
                            ...
                            <?php if ($article['is_editable'] == 1): ?>
                                <span class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded">Edit Approved</span>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-6">
                            <?php if ($article['is_editable'] == 1): ?>
                                <!-- If edit is approved, show a link to the edit page -->
                            ...
                            <?php else: ?>
                                 <!-- Otherwise, show the request edit button -->
                ...
                if (confirm("Are you sure you want to request edit access for this article? An administrator will need to approve it.")) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            requestEditBtn: 1 // This is the trigger for our new handler
                        },
                        success: function(response) {
